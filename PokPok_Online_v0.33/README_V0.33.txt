POK POK ONLINE V0.33
====================

OBJECTIF DE CETTE VERSION
-------------------------
V0.33 réunit le socle multijoueur de V0.29 avec le rendu, la densité visuelle et les animations de la V0.27 PC qui servait de référence.
...
IMPORTANT BOUTIQUE
------------------
Les boutons de prix sont une maquette fonctionnelle d'interface : aucun paiement réel n'est effectué et aucun rubis n'est crédité par un achat dans cette V0.33. Un fournisseur de paiement / achat intégré devra être branché et sécurisé avant publication.
