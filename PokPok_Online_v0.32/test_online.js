...
const os=require('os');
const dataDir=fs.mkdtempSync(path.join(os.tmpdir(),'pokpok-v032-'));
...
(async()=>{const sockets=[];try{
  ...
  console.log("OK V0.32 : 50 rubis à l'inscription, roulette 10-100 (moyenne 50), mises, matchmaking 3/6, pot, confidentialité, chrono 45 s et pioche synchronisée.");
  process.exitCode=0;
