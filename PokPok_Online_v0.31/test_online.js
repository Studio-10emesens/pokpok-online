...
const os=require('os');
const dataDir=fs.mkdtempSync(path.join(os.tmpdir(),'pokpok-v031-'));
...
(async()=>{const sockets=[];try{
  ...
  console.log('OK V0.31 : comptes, 50 rubis/jour, roulette quotidienne, contrôle des mises, matchmaking 3 et 6 joueurs, pot, confidentialité, chrono 45 s et pioche synchronisée.');
  process.exitCode=0;
